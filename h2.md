...
Kolmas luokka liittyy myös admin näkymään, mutta siinä vaaditaan pelkästään, että käyttäjä on autentikoitu. Eli kuka tahansa autentikoitu käyttäjä voi päästä tässä luokassa määirteltyyn näkymään, vaikka tarkoituksena olisi sallia vain admin -käyttäjät.
