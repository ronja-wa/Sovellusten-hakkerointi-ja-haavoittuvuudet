...
Tarkistetaan HTML-koodi ... Valitsin hiirellä hakukentän elementin, jolloin löysin sen Inspector -välilehdessä HTML-koodista. Huomasin, että hakukentän input-tyypiksi on laitettu 'number', jolloin hakukenttään voi syöttää ainoastaan numeroita. Vaihdoin input-tyypiksi 'text' (GeeksforGeeks 2025: HTML Input Type).

<img width="946" height="285" alt="image" src="https://github.com/user-attachments/assets/ec0abf16-f52b-4ea0-b9f5-bf75d5d5121a" />

Syötin kenttään uudestaan saman tekstin kuin aiemmin eli ' OR 1=1; -- Tällä kertaa ei tullutkaan ilmoitusta, jossa pyydetään syöttämään vain numeroita. Sain vastaukseksi salasanan 'foo'.
